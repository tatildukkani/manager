...
<div class="col-md-3">
<img src="http://manage.tatildukkani.com/assets/data/posts/<?php print $pictures[0]['picture']; ?>" width="100%">
...
<div class="col-md-2" style="margin-bottom:15px;">
	<img src="http://manage.tatildukkani.com/assets/data/posts/<?php print $pictures[$i]['picture']; ?>" width="100%">
