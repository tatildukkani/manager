										...
										<li class="media"> 
											...
											<div class="media-right media-middle">
												<ul class="icons-list icons-list-extended text-nowrap">
							                    	<li><a href="javascript:void(0);" onClick="dest('<?php print $results[$i]['attrs']['type']; ?>-<?php print $results[$i]['attrs']['did']; ?>','<?php print $results[$i]['attrs']['name']; ?>');"><i class="icon-dots"></i></a></li>
